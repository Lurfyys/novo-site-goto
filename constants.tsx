...
import { LayoutDashboard, Users, ClipboardCheck, FileBarChart, Bell, Settings, Info } from 'lucide-react'
...
export const SIDEBAR_ITEMS = [
  ...
  { id: 'about',            label: 'Sobre',            icon: <Info size={20} />,            active: false },
]
...
export const MOOD_CHART_DATA: MoodData[] = [
  { day: 'S', value: 30 }, { day: 'T', value: 45 }, { day: 'Q', value: 35 },
  { day: 'Q', value: 40 }, { day: 'S', value: 32 }, { day: 'S', value: 38 }, { day: 'D', value: 42 },
]
